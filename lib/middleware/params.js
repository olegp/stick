...
var isFileUpload = http.isFileUpload, isUrlEncoded = http.isUrlEncoded, 
	parseFileUpload = http.parseFileUpload, parseParameters = http.parseParameters,
    mergeParameter = http.mergeParameter, BufferFactory = http.BufferFactory;
